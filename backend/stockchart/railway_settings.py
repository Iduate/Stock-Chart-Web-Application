...
DEBUG = os.environ.get('DEBUG', 'True') == 'True'  # Enable debug for Railway
...
MIDDLEWARE = [
    ...
    'users.auth_middleware.TokenAuthenticationMiddleware',
    'django.contrib.messages.middleware.MessageMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
    'users.middleware.VisitTrackerMiddleware',
]
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # Simplified for demo
    ],
