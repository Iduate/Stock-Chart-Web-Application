...
if DATABASE_URL and HAS_DJ_DATABASE_URL:
    ...
    # Ensure SSL for production PostgreSQL connections
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # TEMPORARY - Allow all access for testing
    ],
...
# API 키 설정 (python-decouple를 사용하여 .env 파일에서 로드)
